    ...
    useEffect(() => {
        const fetchEvents = async () => {
            try {
                ...
                const response = await axios.get(`${USERTABING}?filter=missed&userId=${userId}`, {
                    headers: {
                ...
                {selectedEvent && (
                    <div className='event-info'>
                        <div className='event-info-img'>
                            <img className='event-img' src={selectedEvent.thumbnail_urls[0] || 'https://via.placeholder.com/500'} alt={selectedEvent.event_name} />
                        </div>
